...
def AmericanPutFD(S0, K, T, sigma, r, Nsteps):
    ...
    for n in np.arange(Nsteps, 0, -1):
        ...
        hc[x_int] = h[x_int, n] - r * dt * h[x_int, n] + beta * (h[x_int + 1, n] - h[x_int - 1, n]) + alpha * (
                h[x_int + 1, n] - 2 * h[x_int, n] + h[x_int - 1, n])
        hc[0] = 2 * hc[1] - hc[2]
...
if __name__ == "__main__":
    ...
    with tf.compat.v1.Session() as sess:
        ...
        loss_tnsr = L1_tnsr + L2_tnsr + L3_tnsr + L4_tnsr * 2
        ...
        for i in range(sampling_stages):
            ...
            for _ in range(steps_per_sample):
                loss, L1, L2, L3, L4, _ = sess.run([loss_tnsr, L1_tnsr, L2_tnsr, L3_tnsr, L4_tnsr, optimizer],
                                                   feed_dict={t_interior_tnsr: t_interior, S_interior_tnsr: S_interior,
                                                              t_terminal_tnsr: t_terminal, S_terminal_tnsr: S_terminal})
